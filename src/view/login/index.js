...
function Login(){
    ...
    return(
        <div>
            ...
            {useSelector(state => state.usuarioLogado) > 0 ?<Redirect to='/fundamentalaluno'/> :null}
        ...
        <input onChange={(e)=> setSenha(e.target.value)}type="password" class="form-control" id="floatingPassword" placeholder="Password"/>
